    ...
    <div class="inbox">
    	 ...
    	 <div class="col-md-4 compose">   	 	
    	 	...
    	 	<div class="compose-block">
    	 		<a href="${pageContext.request.contextPath }/admin/homecontent/add">Create Content</a>
    	 	</div>
    	 	<div class="compose-bottom">
    	 		  <nav class="nav-sidebar">
					<ul class="nav tabs">
			          <li class="active"><a href="${pageContext.request.contextPath }/admin/homecontent/add" data-toggle="tab"><i class="fa fa-inbox"></i>Create Content<span>9</span><div class="clearfix"></div></a></li>
